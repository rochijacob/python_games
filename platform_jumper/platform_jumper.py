...
class Platform(pygame.sprite.Sprite):
    ...
    def update(self, scroll):
        ...
        #chanfe platform direction if it has moved fully
...
while run:
    ...
    if game_over == False:
        ...
        pygame.draw.line(screen, YELLOW, (0, score - high_score + SCROLL_THRESH), (SCREEN_WIDTH, score - high_score + SCROLL_THRESH), 2)
        draw_text('HIGH SCORE', font_small, YELLOW, SCREEN_WIDTH - 130, score - high_score + SCROLL_THRESH)
